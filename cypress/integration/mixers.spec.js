...
describe("invantor application", () => {
  beforeEach(() => {
    ...
    cy.findByRole("tab", { name: "Mixers" }).click();
  });

  it("Mixer should NOT be created with Missing Volume", () => {
  ...
  it("Mixer should NOT be created with Missing Name", () => {
    cy.findByRole("button", { name: "Create" }).click();
  ...
  it("Mixer should NOT be created with missing Critical Volume", () => {
    cy.findByRole("button", { name: "Create" }).click();
    cy.findByRole("textbox", { name: "Name" }).type("New_Mixer_Entry");
    cy.findByRole("textbox", { name: "Volume In Ml" }).type("500");
    cy.findByRole("button", { name: "Submit" }).click();
  ...
  it("Mixer should NOT be created with When Volume in mL is not an integer", () => {
    cy.findByRole("button", { name: "Create" }).click();
    cy.findByRole("textbox", { name: "Name" }).type("New_Mixer_Entry");
  ...
  it("Mixer should NOT be created with When Critical Volume not an integer", () => {
    cy.findByRole("button", { name: "Create" }).click();
    cy.findByRole("textbox", { name: "Name" }).type("New_Mixer_Entry");
    cy.findByRole("textbox", { name: "Volume In Ml" }).type("500");
  ...
  it("Mixer SHOULD be created When correct parameters are passed.", () => {
    cy.findByRole("button", { name: "Create" }).click();
    cy.findByRole("textbox", { name: "Name" }).type("New_Mixer_Entry");
    cy.findByRole("textbox", { name: "Volume In Ml" }).type("500");
